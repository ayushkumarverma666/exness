        ...
        <div className="mx-auto">
          <div className="flex items-center justify-between mb-4 md:mb-0">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-semibold text-black font-ibm-plex-mono tracking-tight">
                exness
              </h1>
            </div>
            ...
            <div className="space-y-4 pt-4 border-t border-gray-200">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="pt-2">
                  <button
                    onClick={() => setIsDepositModalOpen(true)}
                    className="w-full bg-gray-900 text-white text-sm px-4 py-3 rounded-full font-medium transition-colors hover:bg-gray-700"
                  >
                    Deposit
                  </button>
                </div>
